...
// TODO: Implement recursive tree sum with OpenMP tasks.
int tree_sum(Node* root) {
    // TODO: Implement the recursive task-based tree reduction.
    if (root == NULL) return 0;

    int left_sum = 0;
    int right_sum = 0;

    // TODO: Create tasks for left/right subtrees and synchronize.
...
int main(void) {
    ...
    // Exercise: tree sum using tasks.
    int result = 0;
    double t_task0 = omp_get_wtime();
    // TODO: Create the parallel region and call the parallel tree_sum function.
    ...
    printf("[tree-sum] exercise_tasks=%d time=%.6f s | %s\n",
