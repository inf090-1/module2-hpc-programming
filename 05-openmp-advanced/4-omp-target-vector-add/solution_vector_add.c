...
// OpenMP target offload solution: vector compute (compute-intensive).
...
int main(void) {
    ...
    printf("[vector-add] solution_target_offload_time=%.6f s\n", t_gpu);
    printf("[vector-add] solution_result=%s | %s\n",
